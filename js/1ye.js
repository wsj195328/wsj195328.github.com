...
var a='data-lazy'; if($('.gallery-2 .slide0').hasAttr('src')) { a='src'; } $('.gallery-2 .slide0').attr(a, (window.devicePixelRatio > 1) ? ((window.devicePixelRatio > 2) ? 'images/new-1500.png' : 'images/new-1000.png') : 'images/new-500.png');
var a='data-lazy'; if($('.gallery-2 .slide1').hasAttr('src')) { a='src'; } $('.gallery-2 .slide1').attr(a, (window.devicePixelRatio > 1) ? ((window.devicePixelRatio > 2) ? 'images/zhan-wei-fu-1500.jpg' : 'images/zhan-wei-fu-1000.jpg') : 'images/zhan-wei-fu-500.jpg');};
$(window).resize(r);
r();
